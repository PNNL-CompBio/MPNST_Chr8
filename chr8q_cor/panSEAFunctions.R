...
get_gmt1_v2 <- function(gmt.list1 = c("msigdb_Homo sapiens_HS_C2_CP:KEGG_LEGACY",
                                   ...
                                   "msigdb_Homo sapiens_HS_C3_MIR:MIRDB",
                                   "msigdb_Homo sapiens_HS_C5_GO:BP",
                                   "msigdb_Homo sapiens_HS_C5_GO:CC",
                                   "msigdb_Homo sapiens_HS_C5_GO:MF",
                                   "msigdb_Homo sapiens_HS_C6",
                                   "msigdb_Homo sapiens_HS_C2_CP:BIOCARTA",
                                   "msigdb_Homo sapiens_HS_C2_CP:PID",
                                   "msigdb_Homo sapiens_HS_C2_CP:REACTOME",
                                   "msigdb_Homo sapiens_HS_C2_CP:WIKIPATHWAYS"),
    ...
    if (is.data.frame(temp.omics)) {
      ...
      if (!grepl("phospho", names(omics)[i], ignore.case = TRUE)) {
        ...
        if (temp.expr == "CCLE proteomics") {
          temp.expr <- get_CCLE_prot()#read.csv(file.path(base.path, "CCLE_proteomics.csv"))
