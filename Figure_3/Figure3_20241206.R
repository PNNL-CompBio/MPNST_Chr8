...
setwd("/Users/gara093/Library/CloudStorage/OneDrive-PNNL/Documents/MPNST/Chr8/MPNST_Chr8_manuscript/Figure_3")
...
ggplot2::ggsave("Correlated_TFTs_dotPlot_patchworkCollection_minN6_v4.pdf", gsea.dot.plot2, width=11, height=11)
gsea.dot.plot2 <- gsea.dot.plots + plot_layout(nrow = 1, guides='collect')
ggplot2::ggsave("Correlated_TFTs_dotPlot_patchworkCollection_minN6_v5.pdf", gsea.dot.plot2, width=14, height=7)
