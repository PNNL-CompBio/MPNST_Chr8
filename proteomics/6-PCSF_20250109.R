...
#mu.vals <- c(1E-5) # next try adding 1, 1E-7, 1E-3, 1E-5
#omega.vals <- c(2) # next try adding 1, 2
...
selectedVertices <- read.csv("vertices_optimalRun_withSpearmanRho_2025-01-12.csv")
directions <- "positive"
library(RCy3)
